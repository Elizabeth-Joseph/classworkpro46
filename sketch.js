...
if(keyDown(UP_ARROW)&&gameState===initial){
  gamePlay();
}
...
function spawnObstacles(){
  ...
  if(frameCount%100===0){
    obstacle=createSprite(Math.round(random(100,90)),Math.round(random(100,600),20,20));
    obstacle.velocityX=Math.random(1,4);
    obstacle.velocityY=Math.random(1,4);
